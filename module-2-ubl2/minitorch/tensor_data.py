...
class TensorData:
    ...
    def permute(self, *order):
        ...
        shape_new = strides_new = tuple()
        for i, p in enumerate(order):
            shape_new = shape_new + (self.shape[p],)
            strides_new = strides_new + (self._strides[p],)

        newtensor = TensorData(self._storage, shape=shape_new, strides=strides_new)
        return newtensor
        # TODO: Implement for Task 2.1.
        # raise NotImplementedError('Need to implement for Task 2.1')
