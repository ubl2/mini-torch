    ...
    def named_parameters(self):
        ...
        if len(self._modules) == 0:
            ...
            for parameter in self._parameters:
                new_dict[parameter] = self._parameters[parameter]
            ...
            for key in self._modules:
                # print(self._modules[key].named_parameters())
                child_para = dict(self._modules[key].named_parameters())
                # print(child_para)
                for name in child_para:
                    this_para[key + "." + name] = child_para[name]
            # print(this_para.values())
            # return list(this_para.items())
            return this_para
